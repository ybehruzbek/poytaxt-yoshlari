...
import { Flag, Handshake, Lightbulb, Scales } from "@phosphor-icons/react/ssr";
    ...
    <section className={styles.valuesSection}>
      <div className="container">
        ...
        <div className={styles.bentoGrid}>
          ...
          <ScrollReveal delay={1} className={`${styles.bentoCard} ${styles.cardLarge}`}>
          ...
          {/* Card 2: Square */}
          <ScrollReveal delay={2} className={`${styles.bentoCard} ${styles.cardSquare}`}>
            <div className={styles.cardContent}>
              <div className={styles.iconWrap} style={{ background: 'var(--blue-pale)' }}>
                <Handshake weight="duotone" style={{ color: 'var(--blue)', fontSize: '28px' }} />
              </div>
          ...
          {/* Card 3: Square */}
          <ScrollReveal delay={3} className={`${styles.bentoCard} ${styles.cardSquare}`}>
            <div className={styles.cardContent}>
              <div className={styles.iconWrap} style={{ background: 'color-mix(in srgb, var(--amber) 15%, white)' }}>
                <Lightbulb weight="duotone" style={{ color: 'var(--amber)', fontSize: '28px' }} />
              </div>
          ...
          <ScrollReveal delay={4} className={`${styles.bentoCard} ${styles.cardWide}`}>
            <div className={styles.cardContent}>
              <div className={styles.iconWrap} style={{ background: 'var(--green-pale)' }}>
                <Scales weight="duotone" style={{ color: 'var(--green-check)', fontSize: '36px' }} />
              </div>
